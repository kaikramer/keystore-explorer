...
public enum AccessMethodType {
	OCSP("1.3.6.1.5.5.7.48.1", "OcspAccessMethod"), CA_ISSUERS("1.3.6.1.5.5.7.48.2", "CaIssuersAccessMethod"), TIME_STAMPING(
			"1.3.6.1.5.5.7.48.3", "TimeStampingAccessMethod"), CA_REPOSITORY("1.3.6.1.5.5.7.48.5",
			"CaRepositoryAccessMethod");
