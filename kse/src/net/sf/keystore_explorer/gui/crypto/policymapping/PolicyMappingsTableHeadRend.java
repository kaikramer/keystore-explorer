 ...
 */
package net.sf.keystore_explorer.gui.crypto.policymapping;
...
/**
 * Custom cell renderer for the headers of the policy mappings table.
 *
 */
public class PolicyMappingsTableHeadRend extends DefaultTableCellRenderer {
	private static ResourceBundle res = ResourceBundle
			.getBundle("net/sf/keystore_explorer/gui/crypto/policymapping/resources");

	private TableCellRenderer delegate;

	public PolicyMappingsTableHeadRend(TableCellRenderer delegate) {
