...
public enum MSNtdsCaSecurityExtType {
    ...
    MSNtdsCaSecurityExtType(String oid, String friendlyKey) {
        this.oid = oid;
     ...
     */
    public static MSNtdsCaSecurityExtType resolveOid(String oid) {
        for (MSNtdsCaSecurityExtType type : values()) {
