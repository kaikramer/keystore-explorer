...
public class Pkcs10Util {
    ...
    public static PKCS10CertificationRequest generateCsr(X500Principal subjectDN, PublicKey publicKey,
                                                         ...
                                                         String challenge, String unstructuredName,
                                                         Extensions extensions, Provider provider)
     ...
     * @param csr The CSR
     * @return The encoding
     * @throws CryptoException If CSR cannot be encoded
     */
     ...
     * @throws CryptoException If a problem occurs getting the PEM encoded CSR
     */
