...
public enum KeyPairType {
    ...
    MLKEM512("ML-KEM-512", "2.16.840.1.101.3.4.4.1", 6400, 6400, 0),
    MLKEM768("ML-KEM-768", "2.16.840.1.101.3.4.4.2", 9472, 9472, 0),
    MLKEM1024("ML-KEM-1024", "2.16.840.1.101.3.4.4.3", 12_544, 12_544, 0),

    SLHDSA_SHA2_128S("SLH-DSA-SHA2-128S", "2.16.840.1.101.3.4.3.20", 256, 256, 0),
    SLHDSA_SHA2_128F("SLH-DSA-SHA2-128F", "2.16.840.1.101.3.4.3.21", 256, 256, 0),
    SLHDSA_SHA2_192S("SLH-DSA-SHA2-192S", "2.16.840.1.101.3.4.3.22", 384, 384, 0),
    SLHDSA_SHA2_192F("SLH-DSA-SHA2-192F", "2.16.840.1.101.3.4.3.23", 384, 384, 0),
    SLHDSA_SHA2_256S("SLH-DSA-SHA2-256S", "2.16.840.1.101.3.4.3.24", 512, 512, 0),
    SLHDSA_SHA2_256F("SLH-DSA-SHA2-256F", "2.16.840.1.101.3.4.3.25", 512, 512, 0),
    SLHDSA_SHAKE_128S("SLH-DSA-SHAKE-128S", "2.16.840.1.101.3.4.3.26", 256, 256, 0),
    SLHDSA_SHAKE_128F("SLH-DSA-SHAKE-128F", "2.16.840.1.101.3.4.3.27", 256, 256, 0),
    SLHDSA_SHAKE_192S("SLH-DSA-SHAKE-192S", "2.16.840.1.101.3.4.3.28", 384, 384, 0),
    SLHDSA_SHAKE_192F("SLH-DSA-SHAKE-192F", "2.16.840.1.101.3.4.3.29", 384, 384, 0),
    SLHDSA_SHAKE_256S("SLH-DSA-SHAKE-256S", "2.16.840.1.101.3.4.3.30", 512, 512, 0),
