...
public class DSelectStandardExtensionTemplate extends JEscDialog {
    ...
    private void initComponents() {
        ...
        PlatformUtil.setMnemonic(jrbSslServer,
                                 res.getString("DSelectStandardExtensionTemplate.jrbSslServer.mnemonic").charAt(0));
        ...
        PlatformUtil.setMnemonic(jrbSslClient,
                                 res.getString("DSelectStandardExtensionTemplate.jrbSslClient.mnemonic").charAt(0));
        ...
        PlatformUtil.setMnemonic(jrbCodeSigning,
                                 res.getString("DSelectStandardExtensionTemplate.jrbCodeSigning.mnemonic").charAt(0));
    ...
    public static void main(String[] args) throws Exception {
        final KeyPair issuerKP = KeyPairUtil.generateKeyPair(KeyPairType.RSA, 1024, KSE.BC);
        final KeyPair subjectKP = KeyPairUtil.generateKeyPair(KeyPairType.RSA, 1024, KSE.BC);
