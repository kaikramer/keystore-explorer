...
public class DImportKeyPairOpenSsl extends JEscDialog {
    ...
    private PrivateKey loadPrivateKey() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, MessageFormat.format(
                                                  res.getString("DImportKeyPairOpenSsl.PrivateKeyEncrypted.message"),
            ...
            JOptionPane.showMessageDialog(this, MessageFormat.format(
                                                  res.getString("DImportKeyPairOpenSsl.PrivateKeyNotEncrypted" +
                                                                ".message"), privateKeyFile), getTitle(),
                                          JOptionPane.WARNING_MESSAGE);
            jcbEncrypted.setSelected(false);
            return null;
        } catch (PrivateKeyPbeNotSupportedException ex) {
            JOptionPane.showMessageDialog(this, MessageFormat.format(
                                                  res.getString("DImportKeyPairOpenSsl.PrivateKeyPbeNotSupported" +
                                                                ".message"), ex.getUnsupportedPbe()),
                                          getTitle(), JOptionPane.WARNING_MESSAGE);
            return null;
        } catch (FileNotFoundException ex) {
            JOptionPane.showMessageDialog(this, MessageFormat.format(
                                                  res.getString("DImportKeyPairOpenSsl.NoReadFile.message"),
                                                  privateKeyFile), getTitle(),
                                          JOptionPane.WARNING_MESSAGE);
            return null;
        } catch (Exception ex) {
        ...
        try {
            ...
            if ((certs != null) && (certs.length != 0)) {
                ...
                DViewCertificate dViewCertificate = new DViewCertificate(this, MessageFormat.format(
                        res.getString("DImportKeyPairOpenSsl.ViewCertificateDetails.Title"), path), certs, null,
    ...
    private boolean generateCertificate(PrivateKey privateKey) {
        try {
            ...
            DGenerateKeyPairCert dGenerateKeyPairCert = new DGenerateKeyPairCert((JFrame) this.getParent(), null,
                    res.getString("DImportKeyPairOpenSsl.GenerateKeyPairCert.Title"), keyPair,
    ...
    private X509Certificate[] loadCertificates(PrivateKey privateKey) {
        ...
        if (certificatePath.isEmpty()) {
            if (privateKey == null) {
                ...
                int selected = JOptionPane.showConfirmDialog(this,
                        res.getString("DImportKeyPairOpenSsl.ConfirmGenerateCert.message"),
                        res.getString("DImportKeyPairOpenSsl.ConfirmGenerateCert.Title"), JOptionPane.YES_NO_OPTION);
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, MessageFormat.format(
                                                  res.getString("DImportKeyPairOpenSsl.NoReadFile.message"), certificateFile), getTitle(),
                                          JOptionPane.WARNING_MESSAGE);
            return null;
        } catch (Exception ex) {
