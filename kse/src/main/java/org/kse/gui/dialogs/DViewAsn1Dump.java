...
public class DViewAsn1Dump extends JEscFrame {
     ...
     * @param cert   Certificate to display dump for
     * @throws Asn1Exception A problem was encountered getting the extension's ASN.1 dump
     ...
     *
     * @param parent Parent dialog
     * @param crl    CRL to display dump for
     * @throws Asn1Exception A problem was encountered getting the extension's ASN.1 dump
     * @throws IOException   If an I/O problem occurred
     */
     ...
     *
     * @param parent    Parent dialog
     * @param extension Extension to display dump for
     * @throws Asn1Exception A problem was encountered getting the extension's ASN.1 dump
     * @throws IOException   If an I/O problem occurred
     */
     ...
     *
     * @param parent     Parent dialog
     * @param privateKey Private key to display dump for
     * @throws Asn1Exception A problem was encountered getting the private key's ASN.1
     *                       dump
     * @throws IOException   If an I/O problem occurred
     */
     ...
     *
     * @param parent    Parent dialog
     * @param publicKey Public key to display dump for
