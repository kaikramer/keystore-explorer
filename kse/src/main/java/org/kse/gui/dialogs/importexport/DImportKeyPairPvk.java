...
public class DImportKeyPairPvk extends JEscDialog {
        ...
        try {
            ...
            if (privateKey != null) {
                DViewPrivateKey dViewPrivateKey = new DViewPrivateKey(this, MessageFormat.format(
                        res.getString("DImportKeyPairPvk.ViewPrivateKeyDetails.Title"), path), privateKey);
    ...
    private PrivateKey loadPrivateKey() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, MessageFormat.format(
                                                  res.getString("DImportKeyPairPvk.PrivateKeyEncrypted.message"),
            ...
            JOptionPane.showMessageDialog(this, MessageFormat.format(
                                                  res.getString("DImportKeyPairPvk.PrivateKeyNotEncrypted.message"),
                                                  privateKeyFile), getTitle(),
                                          JOptionPane.WARNING_MESSAGE);
            ...
            JOptionPane.showMessageDialog(this,
                                          MessageFormat.format(res.getString("DImportKeyPairPvk.NoReadFile.message"),
                                                               privateKeyFile), getTitle(),
                                          JOptionPane.WARNING_MESSAGE);
            return null;
        } catch (Exception ex) {
        ...
        try {
            ...
            if ((certs != null) && (certs.length != 0)) {
                ...
                DViewCertificate dViewCertificate = new DViewCertificate(this, MessageFormat.format(
                        res.getString("DImportKeyPairPvk.ViewCertificateDetails.Title"), path), certs, null,
    ...
    private boolean generateCertificate(PrivateKey privateKey) {
        try {
            ...
            DGenerateKeyPairCert dGenerateKeyPairCert = new DGenerateKeyPairCert((JFrame) this.getParent(), null,
                    res.getString("DImportKeyPairPvk.GenerateKeyPairCert.Title"), keyPair,
    ...
    private X509Certificate[] loadCertificates(PrivateKey privateKey) {
        ...
        if (certificatePath.isEmpty()) {
            if (privateKey == null) {
                ...
                int selected = JOptionPane.showConfirmDialog(this,
                        res.getString("DImportKeyPairPvk.ConfirmGenerateCert.message"),
                        res.getString("DImportKeyPairPvk.ConfirmGenerateCert.Title"), JOptionPane.YES_NO_OPTION);
        ...
        try {
            byte[] certsBytes = FileUtils.readFileToByteArray(certificateFile);
            X509Certificate[] certs = X509CertUtil.loadCertificates(certsBytes);

            if (certs.length == 0) {
                JOptionPane.showMessageDialog(this, MessageFormat.format(
                                                      res.getString("DImportKeyPairPvk.NoCertsFound.message"), certificateFile), getTitle(),
                                              JOptionPane.WARNING_MESSAGE);
            }
