...
public class JCustomExtendedKeyUsage extends JPanel {
    ...
    private void initComponents() {
        jbAdd = new JButton(new ImageIcon(
                Toolkit.getDefaultToolkit().createImage(getClass().getResource("images/add_custom_eku.png"))));
        ...
        jbEdit = new JButton(new ImageIcon(
                Toolkit.getDefaultToolkit().createImage(getClass().getResource("images/edit_custom_eku.png"))));
        ...
        jbRemove = new JButton(new ImageIcon(
                Toolkit.getDefaultToolkit().createImage(getClass().getResource("images/remove_custom_eku.png"))));
     ...
     *
     * @param customExtKeyUsages custom extended key usages
     */
