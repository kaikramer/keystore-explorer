...
public class DeleteTrustedCertificateAction extends KeyStoreExplorerAction implements HistoryAction {
    ...
    public void deleteSelectedEntry() {
        try {
            ...
            String message = MessageFormat.format(res.getString("DeleteTrustedCertificateAction.ConfirmDelete.message"),
                                                  alias);
            int selected = JOptionPane.showConfirmDialog(frame, message, res.getString(
                    "DeleteTrustedCertificateAction.DeleteEntry.Title"), JOptionPane.YES_NO_OPTION);
