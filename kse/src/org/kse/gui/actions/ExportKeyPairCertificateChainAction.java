...
public class ExportKeyPairCertificateChainAction extends KeyStoreExplorerAction {
    ...
    public ExportKeyPairCertificateChainAction(KseFrame kseFrame) {
        ...
        putValue(SMALL_ICON, new ImageIcon(
                Toolkit.getDefaultToolkit().createImage(getClass().getResource("images/exportkeypaircertchain.png"))));
    }
    ...
    protected void doAction() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(frame, res.getString(
                                                  "ExportKeyPairCertificateChainAction" +
            ...
            JOptionPane.showMessageDialog(frame, message, res.getString(
                    "ExportKeyPairCertificateChainAction.ExportCertificateChain.Title"), JOptionPane.WARNING_MESSAGE);
        } catch (Exception ex) {
