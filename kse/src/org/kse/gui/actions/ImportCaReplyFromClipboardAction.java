...
public class ImportCaReplyFromClipboardAction extends AuthorityCertificatesAction implements HistoryAction {
    ...
    public ImportCaReplyFromClipboardAction(KseFrame kseFrame) {
        ...
        putValue(SMALL_ICON, new ImageIcon(
                Toolkit.getDefaultToolkit().createImage(getClass().getResource("images/importcareplyclipboard.png"))));
    }
    ...
    protected void doAction() {
        try {
            ...
            X509Certificate[] exitingEntryCerts = X509CertUtil.orderX509CertChain(
            ...
            if (!certs[0].getPublicKey().equals(exitingEntryCerts[0].getPublicKey())) {
                JOptionPane.showMessageDialog(frame, res.getString(
                                                      "ImportCaReplyFromClipboardAction.NoMatchPubKeyCaReply.message"),
            ...
            if (!applicationSettings.getEnableImportCaReplyTrustCheck()) {
                ...
                if (certs.length > 1) {
                    ...
                    if (matchAlias == null) {
                        ...
                        JOptionPane.showMessageDialog(frame, res.getString(
                                                              ...
                                                              ".NoMatchRootCertCaReplyConfirm.message"),
                                                      res.getString(
                                                              "ImportCaReplyFromClipboardAction.ImportCaReply.Title"),
                        ...
                        int selected = JOptionPane.showConfirmDialog(frame, res.getString(
                                "ImportCaReplyFromClipboardAction.AcceptCaReply.message"), res.getString(
                                "ImportCaReplyFromClipboardAction.ImportCaReply.Title"), JOptionPane.YES_NO_OPTION);
                ...
                // trust from the certificate and ending with a root CA self-signed certificate
                    ...
                    if (trustChain != null) {
                        ...
                        JOptionPane.showMessageDialog(frame, res.getString(
                                "ImportCaReplyFromClipboardAction.NoTrustCaReply.message"), res.getString(
                                "ImportCaReplyFromClipboardAction.ImportCaReply.Title"), JOptionPane.WARNING_MESSAGE);
                        return;
                    }
                }
            }
            ...
            JOptionPane.showMessageDialog(frame, res.getString(
                                                  "ImportCaReplyFromClipboardAction.ImportCaReplySuccessful.message"),
                                          res.getString("ImportCaReplyFromClipboardAction.ImportCaReply.Title"),
                                          JOptionPane.INFORMATION_MESSAGE);
        } catch (Exception ex) {
    ...
    private X509Certificate[] openCaReply() {
        ...
        try {
            ...
            if (t.isDataFlavorSupported(DataFlavor.stringFlavor)) {
                ...
                if (certs.length == 0) {
                    JOptionPane.showMessageDialog(frame, MessageFormat.format(
                                                          res.getString("ImportCaReplyFromClipboardAction.NoCertsFound.message"), "Clipboard"),
                                                  res.getString("ImportCaReplyFromClipboardAction.OpenCaReply.Title"),
                                                  JOptionPane.WARNING_MESSAGE);
                }
            }
            ...
            DProblem dProblem = new DProblem(frame, res.getString(
                    "ImportCaReplyFromClipboardAction.ProblemOpeningCaReply.Title"), problem);
