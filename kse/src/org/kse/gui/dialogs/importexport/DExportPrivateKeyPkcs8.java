	...
	private void exportPressed() {
			...
			if (jpfPassword instanceof JPasswordQualityField) {
				...
				if (firstPasswordChars == null) {
					JOptionPane.showMessageDialog(this,
							res.getString("DExportPrivateKeyPkcs8.MinimumPasswordQualityNotMet.message"),
							res.getString("DExportPrivateKeyPkcs8.Simple.Title"), JOptionPane.WARNING_MESSAGE);
					return;
				}
		...
		if (exportFile.isFile()) {
			...
			int selected = JOptionPane.showConfirmDialog(this, message,
					res.getString("DExportPrivateKeyPkcs8.Simple.Title"), JOptionPane.YES_NO_OPTION);
