...
public class DImportKeyPairPkcs8 extends JEscDialog {
    ...
    private void privateKeyBrowsePressed() {
        ...
        chooser.setApproveButtonText(res.getString("DImportKeyPairPkcs8.PrivateKeyFileChooser.button"));
    ...
    private void certificateBrowsePressed() {
        ...
        chooser.setMultiSelectionEnabled(false);
        chooser.setApproveButtonText(res.getString("DImportKeyPairPkcs8.CertificateFileChooser.button"));
    ...
    private PrivateKey loadPrivateKey() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, MessageFormat.format(
                                                  res.getString("DImportKeyPairPkcs8.PrivateKeyEncrypted.message"),
            ...
            JOptionPane.showMessageDialog(this, MessageFormat.format(
                                                  res.getString("DImportKeyPairPkcs8.PrivateKeyNotEncrypted.message")
                                                  , privateKeyFile), getTitle(),
                                          JOptionPane.WARNING_MESSAGE);
            ...
            JOptionPane.showMessageDialog(this, MessageFormat.format(
                                                  res.getString("DImportKeyPairPkcs8.PrivateKeyPbeNotSupported" +
                                                                ".message"), ex.getUnsupportedPbe()),
                                          getTitle(), JOptionPane.WARNING_MESSAGE);
            return null;
        } catch (FileNotFoundException ex) {
            JOptionPane.showMessageDialog(this,
                                          MessageFormat.format(res.getString("DImportKeyPairPkcs8.NoReadFile.message"),
                                                               privateKeyFile), getTitle(),
                                          JOptionPane.WARNING_MESSAGE);
            return null;
        } catch (Exception ex) {
        ...
        try {
            ...
            if ((certs != null) && (certs.length != 0)) {
                ...
                DViewCertificate dViewCertificate = new DViewCertificate(this, MessageFormat.format(
                        res.getString("DImportKeyPairPkcs8.ViewCertificateDetails.Title"), path), certs, null,
