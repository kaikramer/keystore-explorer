...
/**
 * Dialog used to add or edit a Netscape SSL Server Name extension.
 *
 */
public class DNetscapeSslServerName extends DExtension {
	 ...
	 *            The parent dialog
	 * @param value
	 *            Netscape SSL Server Name DER-encoded
	 * @throws IOException
	...
	private void initComponents() {
		...
		jpNetscapeSslServerName.setBorder(new CompoundBorder(new EmptyBorder(5, 5, 5, 5), new CompoundBorder(
