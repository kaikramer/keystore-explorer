...
public class DOpenPkcs11KeyStore extends JEscDialog {
    ...
    private void initComponents() {
        ...
        PlatformUtil.setMnemonic(jrbUseExisting,
                                 res.getString("DOpenPkcs11KeyStore.jrbUseExisting.mnemonic").charAt(0));
        ...
        try {
            if (jrbUseExisting.isSelected()) {
                ...
                if (selectedProvider == null) {
                    JOptionPane.showMessageDialog(this,
                                                  res.getString("DOpenPkcs11KeyStore.providerNotInstalled.message"),
            ...
            SwingUtilities.invokeLater(() -> {
                if (DOpenPkcs11KeyStore.this.isShowing()) {
                    ...
                    DProblem dProblem = new DProblem(DOpenPkcs11KeyStore.this,
                                                     res.getString("DOpenPkcs11KeyStore.ProblemLoadingProvider.Title"),
                                                     problem);
