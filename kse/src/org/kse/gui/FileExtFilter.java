...
public class FileExtFilter extends FileFilter {
     ...
     *
     * @param ext         The file extension (eg "exe" for a Windows executable)
     * @param description Short description of the file extension
     */
     ...
     *
     * @param exts        The file extension (eg "exe" for a Windows executable)
     * @param description Short collective description for the file extensions
     */
