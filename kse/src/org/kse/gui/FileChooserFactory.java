...
public class FileChooserFactory {
    ...
    private static final String PUBLIC_KEY_FILE_DESC = MessageFormat.format(
            res.getString("FileChooserFactory.PublicKeyFiles"), PUBLIC_KEY_EXT);
    ...
    private static final String LIB_DLL_FILE_DESC = MessageFormat.format(
            res.getString("FileChooserFactory.LibDllFiles"), LIB_DLL_EXT);

    private static final String LIB_SO_FILE_DESC = MessageFormat.format(res.getString("FileChooserFactory.LibSoFiles"),
                                                                        LIB_SO_EXT);

    private static final String LIB_DYLIB_FILE_DESC = MessageFormat.format(
            res.getString("FileChooserFactory.LibDylibFiles"), LIB_DYLIB_EXT);
